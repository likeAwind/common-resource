package com.windforce.common.resource.schema;

import static com.windforce.common.resource.schema.SchemaNames.*;
...
import com.windforce.common.resource.StorageManagerFactory;
import com.windforce.common.resource.other.FormatDefinition;
import com.windforce.common.resource.other.ResourceDefinition;
import com.windforce.common.resource.reader.ExcelReader;
import com.windforce.common.resource.reader.JsonReader;
...
public class ConfigDefinitionParser extends AbstractBeanDefinitionParser {
	...
	private String[] getResources(String packageName) {
		try {
			...
			String name = com.windforce.common.resource.anno.Resource.class.getName();
